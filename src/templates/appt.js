                          ...
                          <div className="slide">
                              <div className="wrappero app">
                                <Img
                                  className="banner-img"
                                  src={
                                    data.wordpressWpAppartement.acf.appart_featured_img.localFile.childImageSharp.sizes.src
                                  }
                                  sizes={
                                    data.wordpressWpAppartement.acf.appart_featured_img.localFile.childImageSharp.sizes
                                  }
                                />
                                  <div className="overlay"></div>
                                  <div className="text">
                          ...
                          <div className="slide">
                              <div className="wrappero etage">
                                <Img
                                  className="banner-img"
                                  src={
                                    data.wordpressWpAppartement.acf.featured_img_etage.localFile.childImageSharp.sizes.src
                                  }
                                  sizes={
                                    data.wordpressWpAppartement.acf.featured_img_etage.localFile.childImageSharp.sizes
                                  }
                                />
                                  <div className="overlay"></div>
                                  <div className="text">
                          ...
                          <div className="slide">
                              <div className="wrappero visite">
                                <Img
                                  className="banner-img"
                                  src={
                                    data.wordpressWpAppartement.acf.visite_featured_img.localFile.childImageSharp.sizes.src
                                  }
                                  sizes={
                                    data.wordpressWpAppartement.acf.visite_featured_img.localFile.childImageSharp.sizes
                                  }
                                />
                                  <div className="overlay"></div>
                                  <div className="text">
                      ...
                      <div className="slidernested">
                          <div className="slide wrap">
                              <div className="childsliderfirst childslider">
                                                                  ...
                                                                  {wordpressWpAppartement.acf.appartement_image_galerie.map(item => (
                                                                    <div className="slide" key={
                                                    item.appartement.localFile.id
                                                                    }>
                              ...
                              <div className="arrows">
                                  <ul>
                                      <li className="prev6"><img src={Left} alt=""/></li>
                                      <li className="next6"><img src={Right} alt=""/></li>
                                  </ul>
                              </div>
                          </div>
                          <div className="slide wrap">
                              <div className="childslidersec childslider">
                                                                                                  ...
                                                                                                  {wordpressWpAppartement.acf.visite_virtuelle_image_galerie.map(item => (
                                                                                                    <div className="slide" key={
                                                                                    item.visite_virtuelle.localFile.id
                                                                                                    }>
                              ...
                              <div className="arrows">
                                  <ul>
                                      <li className="prev7"><img src={Left} alt=""/></li>
                                      <li className="next7"><img src={Right} alt=""/></li>
                                  </ul>
                              </div>
                          </div>
                          <div className="slide wrap">
                              <div className="childsliderthird">
                                                                                                  ...
                                                                                                  {wordpressWpAppartement.acf.etage_image_galerie.map(item => (
                                                                                                    <div className="slide" key={
                                                                                    item.etage.localFile.id
                                                                                                    }>
                              ...
                              <div className="arrows">
                                  <ul>
                                      <li className="prev8"><img src={Left} alt=""/></li>
                                      <li className="next8"><img src={Right} alt=""/></li>
                                  </ul>
                              </div>
                          </div>
                      </div>
